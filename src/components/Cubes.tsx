...
const Cubes: React.FC<CubesProps> = ({
    ...
    useEffect(() => {
        ...
        // Type casting for event listeners to avoid strict type issues with simple GSAP logic
        const handlePointerMove = (e: Event) => onPointerMove(e as PointerEvent);
    ...
    const sceneStyle: React.CSSProperties = {
        ...
        // Custom properties need to be cast if not in React.CSSProperties, but here we can keep them in style directly?
        // React doesn't like custom props in style object unless cast to any or specific interface.
        // For simplicity, we just use 'any' or ignore the error if it was plain JS. In TS, we can use CSSProperties & Record<string, any>
    } as React.CSSProperties & Record<string, string | number | undefined>;

    // Adding custom properties
    if (colGap) (sceneStyle as any)['columnGap'] = colGap;
    if (rowGap) (sceneStyle as any)['rowGap'] = rowGap;
